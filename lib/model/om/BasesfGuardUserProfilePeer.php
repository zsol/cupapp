...
abstract class BasesfGuardUserProfilePeer {
	...
	const MODIFIED_AT = 'sf_guard_user_profile.MODIFIED_AT';

	/** the column name for the LAST_COMMENTED field */
	const LAST_COMMENTED = 'sf_guard_user_profile.LAST_COMMENTED';

	/** the column name for the LAST_UPLOADED field */
	const LAST_UPLOADED = 'sf_guard_user_profile.LAST_UPLOADED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Email', 'Avatar', 'ModifiedAt', 'LastCommented', 'LastUploaded', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'email', 'avatar', 'modifiedAt', 'lastCommented', 'lastUploaded', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::EMAIL, self::AVATAR, self::MODIFIED_AT, self::LAST_COMMENTED, self::LAST_UPLOADED, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'email', 'avatar', 'modified_at', 'last_commented', 'last_uploaded', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Email' => 2, 'Avatar' => 3, 'ModifiedAt' => 4, 'LastCommented' => 5, 'LastUploaded' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'email' => 2, 'avatar' => 3, 'modifiedAt' => 4, 'lastCommented' => 5, 'lastUploaded' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::EMAIL => 2, self::AVATAR => 3, self::MODIFIED_AT => 4, self::LAST_COMMENTED => 5, self::LAST_UPLOADED => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'email' => 2, 'avatar' => 3, 'modified_at' => 4, 'last_commented' => 5, 'last_uploaded' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::MODIFIED_AT);
		$criteria->addSelectColumn(sfGuardUserProfilePeer::LAST_COMMENTED);
		$criteria->addSelectColumn(sfGuardUserProfilePeer::LAST_UPLOADED);
	}
